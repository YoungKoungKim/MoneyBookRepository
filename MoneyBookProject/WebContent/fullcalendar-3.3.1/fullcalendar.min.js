...
!function(t) {
	...
	function Bt(n) {
		...
		return l && (l += "-"), i = n.data(l + "event") || null, i && (i = "object" == typeof i ? t.extend({}, i) : {}, r = i.start, null == r && (r = i.time), s = i.duration, o = i.stick,
			...
			,
			delete i.stick
			), null == r && (r = n.data(l + "start")), null == r && (r = n.data(l + "time")), null == s && (s = n.data(l + "duration")), null == o && (o = n.data(l + "stick")), r = null != r ? e.duration(r) : null, s = null != s ? e.duration(s) : null, o = Boolean(o), {
				eventProps : i,
				startTime : r,
				duration : s,
				stick : o
	...
	function _t(e, n) {
		...
		var f = this;
		f.setToolbarOptions = i, f.render = r, f.removeElement = s, f.updateTitle = l, f.activateButton = a, f.deactivateButton = u, f.disableButton = c, f.enableButton = d, f.getViewsWithButtons = h, f.el = null;var g,
			p,
			v = []
	}
	function Yt(n, i) {
		...
		function o() {
			...
			}), O = t("<div class='fc-view-container'/>").prependTo(n);var e = y();
		...
		var F = this;
		pe.needed(), F.render = s, F.destroy = l, F.rerenderEvents = m, F.select = D, F.unselect = T, F.zoomTo = C, F.getCalendar = x, F.getView = I, F.option = k, F.recordOptionOverrides = M, F.publiclyTrigger = B, F.dynamicOverrides = {}, F.viewSpecCache = {}, F.optionHandlers = {}, F.overrides = t.extend({}, i), F.populateOptionsHash();var N;
		...
		}, F.freezeContentHeight = H, F.thawContentHeight = R;var q = 0;
		F.initialize()
	}
	function Wt(e) {
	...
	function jt() {
		...
		function f(e, n) {
			...
			var o = e.events;
			if (o)
				t.isFunction(o) ? (U.pushLoading(), o.call(U, j.clone(), q.clone(), U.options.timezone, function(t) {
					n(t), U.popLoading()
		...
		var U = this;
		U.requestEvents = n, U.reportEventChange = i, U.isFetchNeeded = s, U.fetchEvents = o, U.fetchEventSources = u, U.refetchEvents = l, U.refetchEventSources = a, U.getEventSources = S, U.getEventSourceById = w, U.addEventSource = g, U.removeEventSource = v, U.removeEventSources = m, U.updateEvent = H, U.updateEvents = R, U.renderEvent = k, U.renderEvents = L, U.removeEvents = M, U.clientEvents = B, U.mutateEvent = Y, U.normalizeEventDates = V, U.normalizeEventTimes = P;var j,
			q,
			Z,
			$ = {
				events : []
	...
	var Le = Zt.BasicView = be.extend({
		...
		Be = Zt.MonthView = Le.extend({
			buildRenderRange : function() {
				var t,
					e = Le.prototype.buildRenderRange.apply(this, arguments);
